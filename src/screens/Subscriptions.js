...
export const Subscriptions = ({ navigation }) => {
  ...
  useEffect(() => {
    // console.log(connected, purchaseHistory, subscriptions);
    // if(connected) {
    //   handleBuySubscription('americano_premium');
    // }
    ...
    <SafeAreaView>
      <ScrollView>
        <View style={{ padding: 10 }}>
          ...
          >
            subscriptionSkus: {JSON.stringify(subscriptionSkus)}
          </Text>
